...
public:
	...
	unsigned int received  : 1;             // parallel mode: is it received from other solver
        unsigned int age       : 2;             // How long do I know this clause?
        unsigned int padding   : 3;             // save some bits for other bitflags
