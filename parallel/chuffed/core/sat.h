...
public:
  ...
  vec<Clause*> receiveds;           // List of received clauses
  ...
  vec<Lit> analyze_toclear;
	...
	vec<double> activity;                  // A heuristic measurement of the activity of a variable.
        double maxActivity;                    // The maximum of all variable activities
  ...
  long long int clauses_literals, learnts_literals, max_literals, tot_literals;
	...
	bool convertToSClause(Clause& c);
        void convertToClause(SClause& sc);
        void convertToClause(vec<int> & sc);
        void addLearnt();
        void addLearnt(vec<Lit> & toAdd);
